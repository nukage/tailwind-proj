    ...
    <section id="contact">
        <div class="bg-overlay-2">
            ...
            <div class="container mx-auto flex flex-row max-w-5xl">
                <div class="p-1 w-1/2 ">
                    <h4 class="contact-title leading-loose text-3xl text-center font-hairline uppercase "><?php _e( 'Producer', 'nukage_2020' ); ?> <i class="fas fa-circle "></i> <?php _e( 'Performer', 'nukage_2020' ); ?> <i class="fas fa-circle"></i> <?php _e( 'DJ', 'nukage_2020' ); ?> <i class="fas fa-circle"></i> <?php _e( 'Guitarist', 'nukage_2020' ); ?></h4>
                    <div class="flex flex-row">
                        <div class=" md:w-1/2 w-full flex items-center  ">
                            <img class="mx-auto" src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/Nukage-Headshot.png">
                        </div>
                        <div class=" md:w-1/2 w-full oswald leading-loose font-hairline p-3"> 
                ...
                <div class="p-1 md:w-1/2 w-full border border-risered_2   rounded-lg ">
                    <h4 class="contact-title leading-loose text-3xl text-center font-hairline uppercase "><?php _e( 'Let\'s Chat!', 'nukage_2020' ); ?></h4>
                </div>
            </div>
        </div>
    </section>
