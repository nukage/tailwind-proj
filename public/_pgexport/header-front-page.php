        ...
        <div class="navbar w-full fixed z-10 ">
            <div class="nav-main-menu bg-black">
                <div class="container mx-auto sm:h-24 h-16 px-5  flex flex-row  justify-between items-center ">
                    ...
                    <div class="">
                        <a href="#" class="sign-up-nav-link text-risered border border-risered uppercase p-2 rounded-lg hover:bg-risered hover:text-black oswald "><?php _e( 'Sign', 'nukage2020' ); ?> <?php _e( 'Up', 'nukage2020' ); ?> <span class="md:inline hidden "><?php _e( 'For Updates', 'nukage2020' ); ?></span> </a>
                    </div>
                </div>
            </div>
            <div class="bg-trans-bk">
                <div class="nav-sub-menu container mx-auto md:h-8 px-5 py-3  flex flex-row  justify-between items-center oswald uppercase text-sm ">
                    <ul class="menu flex flex-row flex-wrap md:items-center  align-middle text-center w-full  md:justify-between justify-center ">
                        <li class="lah">
                            <a href="#quick-stats"><span class="md:inline hidden "><?php _e( 'Quick', 'nukage2020' ); ?></span> <?php _e( 'Stats', 'nukage2020' ); ?></a>
                        </li>
                        <li class="lah">
                        ...
                        <li class="lah">
                            <a href="#gallery"><span class="md:inline hidden "><?php _e( 'Artist', 'nukage2020' ); ?></span> <?php _e( 'Photos', 'nukage2020' ); ?></a>
                        </li>
                        <li class="lah">
                            <a href="#videos"><?php _e( 'Videos', 'nukage2020' ); ?></a>
                        </li>
                        <li class="lah">
                        ...
                        <li class="lah">
                            <a href="#contact"><?php _e( 'Contact', 'nukage2020' ); ?></a>
                        </li>
                    </ul>
                </div>
            </div>
